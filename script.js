...
function efectoHabilidades(){
    ...
    if (distancia_skills >= 300){
        ...
        document.getElementById("pixeles").classList.add("barra-progreso3");
        document.getElementById("vectores").classList.add("barra-progreso4");
    }
};
...
//funcion para enviar email en la seccion contacto
...
document.getElementById('form')
 .addEventListener('submit', function(event) {
   ...
   const templateID = 'template_x5jmpmh';
